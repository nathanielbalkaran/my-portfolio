...
export function LocaleToggle() {
  ...
  return (
    ...
    >
      <span className={locale === "en" ? "font-bold text-foreground group-hover:text-black" : "text-foreground/60 group-hover:text-black/70"}>
        EN
      </span>
      <span className="text-foreground/40 group-hover:text-black/50" aria-hidden>//</span>
      <span className={locale === "fr" ? "font-bold text-foreground group-hover:text-black" : "text-foreground/60 group-hover:text-black/70"}>
        FR
      </span>
    </button>
  );
